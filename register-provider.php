			...
			<section class="ls section_padding_top_100 section_padding_bottom_100">
				<div class="container">
					<div class="row">
						...
						<form class="shop-register" role="form" action="includes/register-specialist.php" method="POST">
							<div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group validate-required validate-phone" id="billing_phone_field">
									...
									<input type="text" class="form-control " name="phone" id="billing_phone" placeholder="" value="" required>
								</div>
                            </div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="billing_state" class="control-label">
										<span class="grey">Specialty</span>
										<span class="required">*</span>
									</label>
									<select class="form-control" name="specialty" id="billing_state">
                                        <option value="DTherapist">DTherapist</option>
                                        <option value="Faith-based Counsellor (Christainity)">Faith-based Counsellor (Christainity)</option>
                                        <option value="Faith-based Counsellor (Islam)">Faith-based Counsellor (Islam)</option>
									</select>
								</div>
                            </div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="billing_state" class="control-label">
										<span class="grey">Brief Description about yourself</span>
										<span class="required">*</span>
									</label>
									<textarea type="text" class="form-control " name="about" iplaceholder="" value="" required></textarea>
								</div>
                            </div>
