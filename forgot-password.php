	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="ls section_padding_top_100 section_padding_bottom_100">
				<div class="container">
					<div class="row">
                        <p style="color:black">Enter your Email and we will send you instructions on how to recover your Password</p>
                        <?php
						...
						<form class="shop-register" onsubmit="return validateForm()" role="form" action="includes/forgot-password.php" method="POST">
							<div class="col-sm-6">
								<div class="form-group validate-required" id="billing_first_name_field">
									<label for="billing_first_name" class="control-label">
										<span class="grey">Enter Email</span>
										<span class="required">*</span>
									</label>
									<input type="email" class="form-control " name="email" id="password1" placeholder="" value="" required>
								</div>
                            </div>
