				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6 col-md-pull-6">
							...
							<ul class="list1 no-bullets playfair fontsize_16 topmargin_40">
								<li>
									<div class="row columns_margin_0 columns_padding_0">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-md-push-6 text-center">
							<h2 class="section_header">Welcome to DTherapist &amp; Family Consulting</h2>
							<br>
							...
							<div class="with_icon topmargin_60">
								...
								<span class="lightgrey">DTherapist</span>
							</div>
...
<!-- Mirrored from html.modernwebtemplates.com/DTherapist/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Jan 2024 17:29:36 GMT -->
</html>