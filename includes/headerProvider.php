<?php
	...
	if(!isset($_SESSION['dTheraSpeci'])){
		header("Location: login-provider");
		exit();
	}
    include 'includes/connect_to_db.php';
    include 'includes/providerData.php';
?>
<!DOCTYPE html>
            ...
            if($message == 'Registration Complete.'){
                echo'<div class="modal fade" tabindex="-1" role="dialog" id="messages_modal">
                        <div class="fw-messages-wrap ls with_padding" style="color:black">
                            ...
                            Our team of experienced professional and faith based therapists are here to offer expert advice, guidance, and support. Additionally, our AI assistant is available to provide limited advice and guidance to help you get started or answer any immediate questions you may have.<br><br>

                            Remember, you are not alone, and we are here to support you every step of the way.<br><br>
                            
                            <ul class="list-unstyled">
                                <li><b>Obianuju Oji</b></li>
                            </ul>
									...
									<a href="#">
                                        <div class="media">
											...
											<div class="media-body media-middle">
												<h4 style="color:white"><?php echo $fname.' '.$lname; ?><br>
                                                <?php echo $specialty; ?>
												</h4>
							...
							<ul class="menu-click">
								<li>
									<a href="provider-dashboard">
										...
										D<span style="text-transform: lowercase;">ashboard</span>
									</a>
								...
								<li>
									...
									<ul>
										...
										<li>
											<a href="provider-archived-appointments">
												A<span style="text-transform: lowercase;">rchived</span>
											</a>
										</li>
								...
								<li>
									<a href="posts">
										<i class="fa fa-file-text"></i>
										P<span style="text-transform: lowercase;">osts</span>
									</a>
									<ul>
										<li>
											<a href="posts">
										...
										<li>
											<a href="create-post">
												C<span style="text-transform: lowercase;">reate a</span> P<span style="text-transform: lowercase;">ost</span>
											</a>
										</li>
								...
								<li>
									<a href="#">
										...
										<span style="color:gray">
											P<span style="text-transform: lowercase;">roducts</span>
										</span>
									</a>
									<ul>
										<li>
										...
										<li>
											<a href="#">
												<span style="color:gray">
													P<span style="text-transform: lowercase;">ost a</span>  P<span style="text-transform: lowercase;">roduct</span>
												</span>
											</a>
										</li>
