<?php 
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $registrationType = mysqli_real_escape_string($conn, $_POST['registrationType']);

       // echo $registrationType;exit();
        ...
        elseif($registrationType == 'Provider'){
            //prevent double registration
        ...
        header("Location: ../index?message=The system experienced a Fatal error!");
        exit();
    }
?>